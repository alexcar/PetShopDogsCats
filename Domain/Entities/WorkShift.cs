namespace Domain.Entities
{
    public class WorkShift : BaseEntity
    {
        ...
        public WorkShift(bool monday, byte? mondayFrom, byte? mondayTo, bool tuesday, byte? tuesdayFrom, byte? tuesdayTo, bool wednesday, byte? wednesdayFrom, byte? wednesdayTo, bool thursday, byte? thursdayFrom, byte? thursdayTo, bool friday, byte? fridayFrom, byte? fridayTo, bool saturday, byte? saturdayFrom, byte? saturdayTo, bool sunday, byte? sundayFrom, byte? sundayTo)
        {
            Monday = monday;
